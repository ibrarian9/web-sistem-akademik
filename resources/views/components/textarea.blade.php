...
@php
    $inputId = $name ? preg_replace('/[^a-zA-Z0-9_-]/', '_', $name) : 'textarea_' . uniqid();
...
<div class="space-y-1.5 w-full">
    ...
    <div class="relative rounded-xl shadow-2xs">
        <textarea
            ...
            {{ $attributes->merge([
                'class' => 'w-full py-2.5 px-3.5 bg-white border rounded-xl text-stone-900 placeholder-stone-400 text-xs font-semibold focus:outline-none transition duration-150 ' . 
                    ($hasError 
