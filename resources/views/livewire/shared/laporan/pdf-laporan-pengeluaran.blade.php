...
<head>
    <meta charset="utf-8">
    <title>Laporan Pengeluaran Keuangan</title>
    <style>
        body {
...
<body>
    ...
    <div class="title">LAPORAN PENGELUARAN KEUANGAN YAYASAN</div>
        ...
        <tbody>
            @forelse ($data as $index => $row)
                <tr>
                    ...
                    <td class="text-right" style="color: #b91c1c;">Rp {{ number_format($row->jumlah, 0, ',', '.') }}</td>
                </tr>
            @empty
                <tr>
                    <td colspan="5" class="text-center" style="padding: 15px; color: #777;">
                        Tidak ada data pengeluaran keuangan yang ditemukan.
                    </td>
                </tr>
            @endforelse
        </tbody>
    ...
    <div class="total-box" style="color: #b91c1c;">
