...
<body>
    ...
    <div class="header">
        <table>
            <tr>
                <td>
                    <div class="header-title">REKAP ABSENSI GURU</div>
    ...
    <table class="info-table">
        <tr>
            <td class="info-label">Laporan</td>
            <td class="info-value">: Kehadiran Guru Aktif</td>
    ...
    <table class="data-table">
        <thead>
            <tr>
                ...
                <th style="width: 140px; text-align: left; padding-left: 5px;">Nama Guru</th>
                @for ($day = 1; $day <= $daysInMonth; $day++)
                    <th style="width: 18px;">{{ $day }}</th>
                @endfor
                <th style="width: 20px; background-color: #dcfce7; color: #166534;">H</th>
                <th style="width: 20px; background-color: #ffedd5; color: #c2410c;">T</th>
                <th style="width: 20px; background-color: #fef3c7; color: #92400e;">I</th>
                <th style="width: 20px; background-color: #fee2e2; color: #991b1b;">A</th>
        ...
        <tbody>
            @foreach ($matrix as $index => $row)
                <tr>
                    ...
                    <td class="summary-col" style="color: #c2410c;">{{ $row['telat'] }}</td>
    ...
    <div class="legend">
        ...
        <span>
            <span class="legend-box status-h">H</span> Hadir Tepat Waktu
        </span>
        <span>
            <span class="legend-box status-t">T</span> Hadir Terlambat
        </span>
        <span>
