<div class="space-y-6 font-sans">
    ...
    >
        <x-slot:actions>
            <x-button variant="outline" size="sm" icon="printer" wire:click="exportPdf" :disabled="$paginatedInflows->total() === 0" title="{{ $paginatedInflows->total() === 0 ? 'Tidak ada catatan pemasukan untuk diekspor' : 'Ekspor Dokumen PDF Sesuai Filter' }}">
                Cetak PDF
            </x-button>
