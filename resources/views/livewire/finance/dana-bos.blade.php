<div class="space-y-6">
    ...
    <!-- Info & Tutorial Box -->
    <x-info-tutorial-box 
        title="Petunjuk Pengelolaan & Realisasi Dana BOS"
        :steps="[
            ['title' => 'Catat Penerimaan / Pengeluaran', 'desc' => 'Pilih jenis transaksi (Pemasukan Tahap I/II atau Pengeluaran RKAS BOS).'],
            ['title' => 'Nomor Bukti & Keterangan', 'desc' => 'Lengkapi nomor bukti transaksi kwitansi dan alokasi mata anggaran BOS.'],
            ['title' => 'Perhitungan Saldo', 'desc' => 'Panel atas menampilkan total penerimaan, alokasi terpakai, dan sisa saldo BOS secara otomatis.']
        ]"
    />
