                    ...
                    <tr class="hover:bg-slate-905 transition-colors">
                        ...
                        <td class="px-6 py-4 text-right">
                            <div class="inline-flex gap-2">
                                <button wire:click="openEdit({{ $guru->id }})" class="p-1.5 bg-slate-800 border border-slate-750 text-indigo-400 hover:text-white hover:bg-indigo-600 rounded-lg transition duration-200">
                                    <x-lucide-edit class="w-3.5 h-3.5" />
                                </button>
                                <button onclick="confirm('Apakah Anda yakin ingin menghapus data guru ini?') || event.stopImmediatePropagation()" wire:click="delete({{ $guru->id }})" class="p-1.5 bg-slate-800 border border-slate-750 text-rose-400 hover:text-white hover:bg-rose-600 rounded-lg transition duration-200">
