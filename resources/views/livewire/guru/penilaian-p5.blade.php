<div class="space-y-6 font-sans">
    ...
    <div class="flex items-center gap-2 bg-white border border-stone-200 p-2 rounded-2xl overflow-x-auto shadow-xs">
        ...
        @if($isUmum || $isKeduanya)
            <a href="{{ route('guru.penilaian-p5') }}" class="px-4 py-2.5 rounded-xl text-xs font-bold bg-cyan-700 text-white shadow-sm flex items-center gap-2.5 whitespace-nowrap">
