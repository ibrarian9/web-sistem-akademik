...
## Corpus Check
- 322 files · ~202,647 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1563 nodes · 2937 edges · 218 communities (158 shown, 60 thin omitted)
- Extraction: 82% EXTRACTED · 18% INFERRED · 0% AMBIGUOUS · INFERRED: 518 edges (avg confidence: 0.8)
...
Cohesion: 0.26
Nodes (4): InputNilaiSumatif, NilaiSas, NilaiSumatifTp, Illuminate\Database\Eloquent\Relations\BelongsTo
...
Cohesion: 0.12
Nodes (4): LaporanTunggakan, Dashboard, Tagihan, AutomatedSppGenerationTest

### Community 15 - "Guru"
Cohesion: 0.06
Nodes (6): ManajemenGuru, ManajemenKelas, Dashboard, ManajemenSurat, Guru, RiwayatSurat
...
### Community 31 - ".run"
Cohesion: 0.14
Nodes (5): Ekstrakurikuler, RaporDetail, SiswaEkstrakurikuler, SiswaKelas, RaporOrangTuaSeeder
...
### Community 36 - "Role"
Cohesion: 0.06
Nodes (14): ManajemenUser, ManajemenKaryawan, Role, DatabaseSeeder, JenisTagihanSeeder, KategoriPengeluaranSeeder, KomponenNilaiSeeder, PengaturanSeeder (+6 more)
...
Cohesion: 0.06
Nodes (18): GenerateMonthlySpp, GenerateMonthlySppCommand, ArusMasuk, EkstrakurikulerSaya, AuditLog, User, Illuminate\Console\Command, Illuminate\Database\Eloquent\Factories\HasFactory (+10 more)
...
### Community 48 - "ESignatureService"
Cohesion: 0.21
...
### Community 51 - "LingkupMateri"
Cohesion: 0.23
Nodes (3): LingkupMateri, TujuanPembelajaran, Illuminate\Database\Eloquent\Relations\HasMany
...
## Knowledge Gaps
- **347 isolated node(s):** `$schema`, `name`, `type`, `description`, `laravel` (+342 more)
...
- **Why does `Siswa` connect `Siswa` to `Illuminate\Database\Eloquent\Relations\BelongsTo`, `AbsensiSiswa`, `Illuminate\Database\Eloquent\Model`, `GuruMapelKelas`, `Kelas`, `Tagihan`, `Guru`, `NilaiTahfidz`, `JenisTagihan`, `Semester`, `NilaiP5`, `.run`, `Pembayaran`, `ProsesKenaikanKelas`, `InputPembayaran`, `Role`, `.run`, `OverviewPembayaran`, `Livewire\Component`, `ManajemenRemedial`, `LingkupMateri`, `RekapAbsensiSiswa`, `InputNilaiSiswa`, `Rapor`, `KelolaRapor`, `.generateForMapel`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `User` connect `Livewire\Component` to `UserFactory.php`, `Role`, `.run`, `Siswa`, `Tagihan`, `Guru`, `ESignatureService`, `Pengaturan`, `.paySalary`, `NilaiTahfidz`, `Semester`, `InputAbsensiKaryawan`, `ProfilSaya`, `TahunAjaran`, `.run`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `Guru` connect `Guru` to `Illuminate\Database\Eloquent\Model`, `Role`, `.run`, `ManajemenPiketGuru`, `Livewire\Component`, `ManajemenRemedial`, `Tagihan`, `NilaiTahfidz`, `ManajemenGajiGuru`, `RekapAbsensiGuru`, `Semester`, `InputAbsensiKaryawan`, `.run`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Are the 63 inferred relationships involving `Siswa` (e.g. with `.handle()` and `.handle()`) actually correct?**
  _`Siswa` has 63 INFERRED edges - model-reasoned connections that need verification._
