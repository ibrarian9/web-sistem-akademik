...
## Corpus Check
- 382 files · ~238,464 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1846 nodes · 3542 edges · 261 communities (192 shown, 69 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 505 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1060ae57`
...
8. `TahunAjaran` - 35 edges
9. `Role` - 33 edges
10. `Pengeluaran` - 26 edges
...
Cohesion: 0.05
Nodes (13): InputNilaiSumatif, KelolaRapor, ManajemenKurikulumMerdeka, ManajemenMapel, LingkupMateri, MataPelajaran, NilaiSas, NilaiSumatifTp (+5 more)

### Community 3 - "Illuminate\Database\Eloquent\Model"
Cohesion: 0.08
Nodes (11): AbsensiSiswa, BobotNilaiGuru, DanaBos, DimensiP5, JadwalPelajaran, ProyekP5, RaporTahfidzDetail, SubdimensiP5 (+3 more)

### Community 4 - "Notifikasi"
Cohesion: 0.09
Nodes (9): ManajemenKoreksiNilai, ManajemenKoreksiNilai, NotificationDropdown, NotificationsList, Notifikasi, PengajuanKoreksiNilai, AuditLogger, NotificationService (+1 more)
...
Cohesion: 0.22
Nodes (3): PemasukanKas, Illuminate\Database\Eloquent\SoftDeletes, Illuminate\Notifications\Notifiable
...
Cohesion: 0.07
Nodes (4): ArusKasMasuk, DanaBos, setPeriode(), updatedFilterPeriode()

### Community 21 - "Role"
Cohesion: 0.19
Nodes (5): Role, DemoDataSeeder, ProductionAccountsSeeder, GuruRoleAccessTest, KenaikanKelasExportTest
...
Cohesion: 0.11
Nodes (5): DocumentVerificationController, LaporanPemasukan, JenisTagihan, Pembayaran, FinanceSeeder
...
### Community 40 - "PengajuanDana"
Cohesion: 0.16
Nodes (3): PengajuanDanaIndex, KategoriPengeluaran, PengajuanDana
...
Cohesion: 0.08
Nodes (4): ArusKas, ArusKasKeluar, LaporanPengeluaran, Pengeluaran
...
### Community 74 - "User"
Cohesion: 0.09
Nodes (11): User, UserSeeder, Illuminate\Foundation\Auth\User, Illuminate\Foundation\Testing\RefreshDatabase, Illuminate\Foundation\Testing\TestCase, AutomatedSppGenerationTest, GuruDashboardTest, GuruStudentClassDisplayTest (+3 more)
...
### Community 206 - ".run"
Cohesion: 0.09
Nodes (8): EkstrakurikulerSaya, Ekstrakurikuler, Rapor, RaporDetail, SiswaEkstrakurikuler, SiswaKelas, ProductionDataSeeder, RaporOrangTuaSeeder
...
Cohesion: 0.08
Nodes (11): Controller, FinanceExportController, FinanceReportController, RaporPdfController, VerifikasiDokumenController, RoleMiddleware, Login, ProfilSaya (+3 more)
...
## Knowledge Gaps
- **409 isolated node(s):** `$schema`, `name`, `type`, `description`, `laravel` (+404 more)
...
- **Why does `Siswa` connect `Siswa` to `MataPelajaran`, `NilaiTahfidz`, `Illuminate\Database\Eloquent\Model`, `Livewire\Component`, `Tagihan.php`, `Kelas`, `InputPembayaran`, `ManajemenSurat`, `Auditable.php`, `Role`, `NilaiP5`, `TabunganSiswa`, `AbsensiSiswa`, `Pembayaran`, `ProsesKenaikanKelas`, `RaporOrangTuaSeeder.php`, `OverviewPembayaran`, `Kelas.php`, `ManajemenRemedial`, `ManajemenTagihan`, `Nilai`, `.handle`, `Semester`, `Tagihan`, `User`, `RekapAbsensiSiswa`, `.run`, `FatalAndStrangeScenariosTest.php`, `ManajemenSiswa`, `Illuminate\Http\Request`, `.getMatrixData`, `Dashboard`?**
  _High betweenness centrality (0.062) - this node is a cross-community bridge._
- **Why does `Kelas` connect `Kelas` to `MataPelajaran`, `NilaiTahfidz`, `Illuminate\Database\Eloquent\Model`, `TahunAjaran`, `InputPembayaran`, `Auditable.php`, `Role`, `NilaiP5`, `TabunganSiswa`, `Pembayaran`, `ProsesKenaikanKelas`, `OverviewPembayaran`, `Kelas.php`, `ManajemenRemedial`, `Nilai`, `Semester`, `Tagihan`, `User`, `RekapAbsensiSiswa`, `.run`, `ManajemenSiswa`, `.getMatrixData`, `ManajemenKelas`, `Dashboard`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `Guru` connect `Guru` to `Illuminate\Database\Eloquent\Model`, `ManajemenSurat`, `Pengaturan`, `Auditable.php`, `ManajemenGajiGuru`, `Role`, `AbsensiGuru`, `Pembayaran`, `CapaianGuru`, `ManajemenRemedial`, `Nilai`, `ManajemenKaryawan`, `Semester`, `Tagihan`, `User`, `.run`, `CapaianPengembanganGuru`, `ManajemenPeminjaman`, `ManajemenKelas`, `ManajemenGuru`, `Dashboard`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
