...
## Corpus Check
- 385 files · ~244,962 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1918 nodes · 3677 edges · 261 communities (196 shown, 65 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 601 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4d86d28c`
...
## Communities (261 total, 65 thin omitted)
...
### Community 2 - "Role"
Cohesion: 0.12
Nodes (6): ManajemenKaryawan, Role, TahfidzMutabaahSeeder, UserSeeder, GuruStudentClassDisplayTest, KenaikanKelasExportTest
...
Cohesion: 0.10
Nodes (4): LaporanTunggakan, TagihanSpp, Tagihan, AutomatedSppGenerationTest
...
Cohesion: 0.09
Nodes (5): ArusMasuk, EkstrakurikulerSaya, TabunganSaya, Livewire\Component, Livewire\WithPagination
...
### Community 204 - "ArusKas"
Cohesion: 0.12
Nodes (3): ArusKas, setPeriode(), updatedFilterPeriode()

### Community 205 - "Guru"
Cohesion: 0.11
Nodes (3): Dashboard, Guru, GuruRoleAccessTest
...
Cohesion: 0.16
Nodes (4): TahunAjaran, CapaianGuruSeeder, DemoDataSeeder, KalenderAkademikTest
...
### Community 271 - "post-create-project-cmd"
Cohesion: 0.50
...
- **Why does `Siswa` connect `Siswa` to `MataPelajaran`, `GuruMapelKelas`, `Role`, `Notifikasi`, `DetailTagihanSiswa`, `RekapAbsensiSiswa`, `Siswa.php`, `Kelas`, `Tagihan`, `ManajemenSurat`, `Auditable.php`, `InputPembayaran`, `KelolaRapor`, `Illuminate\Database\Eloquent\Model`, `NilaiTahfidz`, `TabunganSiswa`, `Pembayaran`, `OverviewPembayaran`, `NilaiP5`, `ManajemenRemedial`, `ManajemenTagihan`, `Nilai`, `.mount`, `AbsensiSiswa`, `Guru`, `.run`, `Semester`, `TahunAjaran`, `ProsesKenaikanKelas`, `.run`, `JenisTagihan`, `Rapor`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `ManajemenTagihan` connect `ManajemenTagihan` to `JenisTagihan`, `Livewire\Component`, `ArusKas`, `Siswa`, `Tagihan`, `Auditable.php`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `User` connect `User` to `Role`, `Guru.php`, `Pengaturan`, `Siswa.php`, `Siswa`, `Tagihan`, `ManajemenUser`, `Auditable.php`, `ManajemenGajiGuru`, `Illuminate\Database\Eloquent\Model`, `NilaiTahfidz`, `AbsensiGuru`, `Livewire\Component`, `Illuminate\Database\Seeder`, `UserFactory.php`, `auth.php`, `Guru`, `.run`, `TahunAjaran`, `.run`, `ManajemenGuru`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Are the 68 inferred relationships involving `Siswa` (e.g. with `.handle()` and `.handle()`) actually correct?**
  _`Siswa` has 68 INFERRED edges - model-reasoned connections that need verification._
