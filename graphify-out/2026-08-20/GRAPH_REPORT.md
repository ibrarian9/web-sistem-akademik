# Graph Report - web-sistem-akademik  (2026-08-20)

## Corpus Check
- 356 files · ~226,526 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1714 nodes · 3259 edges · 241 communities (174 shown, 67 thin omitted)
- Extraction: 83% EXTRACTED · 17% INFERRED · 0% AMBIGUOUS · INFERRED: 567 edges (avg confidence: 0.8)
...
## Communities (241 total, 67 thin omitted)
...
Cohesion: 0.11
Nodes (9): AbsensiSiswa, BobotNilaiGuru, DanaBos, JadwalPelajaran, RaporTahfidzDetail, SubdimensiP5, TargetHafalanTahfidz, Illuminate\Database\Eloquent\Factories\HasFactory (+1 more)
...
Cohesion: 0.13
Nodes (12): DatabaseSeeder, DemoDataSeeder, FinanceSeeder, JenisTagihanSeeder, KategoriPengeluaranSeeder, KomponenNilaiSeeder, ProductionDataSeeder, RaporOrangTuaSeeder (+4 more)
...
### Community 12 - "Kelas"
Cohesion: 0.08
Nodes (4): Dashboard, PlottingSiswaKelas, Kelas, GuruStudentClassDisplayTest
...
Cohesion: 0.11
Nodes (5): Controller, RaporPdfController, Dashboard, SetoranTahfidz, Semester

### Community 18 - "ManajemenGajiGuru"
Cohesion: 0.13
Nodes (3): FinanceReportController, ManajemenGajiGuru, GajiGuru
...
### Community 38 - "Role"
Cohesion: 0.11
Nodes (5): ManajemenUser, ManajemenKaryawan, Role, GuruRoleAccessTest, KenaikanKelasExportTest
...
### Community 58 - "PengajuanKoreksiNilai"
Cohesion: 0.22
...
Cohesion: 0.06
Nodes (8): ArusKas, ArusKasKeluar, ArusKasMasuk, LaporanPengeluaran, PengajuanDanaIndex, PemasukanKas, PengajuanDana, Pengeluaran
...
### Community 74 - "User"
Cohesion: 0.11
Nodes (10): User, ProductionAccountsSeeder, Illuminate\Foundation\Auth\User, Illuminate\Foundation\Testing\RefreshDatabase, Illuminate\Foundation\Testing\TestCase, Illuminate\Notifications\Notifiable, GuruDashboardTest, createUserWithRole() (+2 more)
...
### Community 207 - ".run"
Cohesion: 0.14
Nodes (4): KategoriPengeluaran, Peminjaman, SiswaKelas, NotificationService

### Community 208 - "Livewire\Component"
Cohesion: 0.11
Nodes (6): ArusMasuk, TabunganSaya, AuditLogger, bootAuditable(), Livewire\Component, Livewire\WithPagination
...
- **Why does `User` connect `User` to `Illuminate\Database\Eloquent\Model`, `ProductionDataSeeder.php`, `Illuminate\Database\Seeder`, `Siswa`, `InputAbsensiKaryawan`, `Kelas`, `Tagihan`, `Semester`, `Guru.php`, `TahunAjaran`, `Role`, `Siswa.php`, `ESignatureService`, `auth.php`, `UserFactory.php`, `ManajemenGuru`, `.run`, `.run`, `Livewire\Component`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `Siswa` connect `Siswa` to `MataPelajaran`, `Illuminate\Database\Eloquent\Model`, `Notifikasi`, `ProductionDataSeeder.php`, `Kelas`, `Tagihan`, `ManajemenSurat`, `Semester`, `JenisTagihan`, `AbsensiSiswa`, `PenilaianP5.php`, `TabunganSiswa`, `TahunAjaran`, `Pembayaran`, `ProsesKenaikanKelas`, `NilaiTahfidz`, `Role`, `OverviewPembayaran`, `Siswa.php`, `ManajemenRemedial`, `RekapAbsensiSiswa`, `.run`, `.run`, `Livewire\Component`, `InputNilaiSiswa`, `Rapor`, `GuruMapelKelas`, `InputPembayaran`, `KelolaRapor`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `TahunAjaran` connect `TahunAjaran` to `Pembayaran`, `ManajemenKalenderAkademik`, `CapaianGuru`, `Illuminate\Database\Eloquent\Model`, `ProductionDataSeeder.php`, `OverviewPembayaran`, `DanaBos`, `.run`, `.run`, `Tagihan`, `JenisTagihan`?**
