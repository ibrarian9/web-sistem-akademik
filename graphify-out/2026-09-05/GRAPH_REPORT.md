...
## Corpus Check
- 432 files · ~322,313 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2176 nodes · 4235 edges · 298 communities (227 shown, 71 thin omitted)
...
Cohesion: 0.09
Nodes (11): AbsensiSiswa, BobotNilaiGuru, DanaBos, JadwalPelajaran, JadwalRemedial, PengajuanKoreksiNilai, RaporTahfidzDetail, SubdimensiP5 (+3 more)
...
### Community 32 - "InputNilaiSumatif.php"
Cohesion: 0.12
...
Cohesion: 0.13
Nodes (5): ManajemenKoreksiNilai, ManajemenKoreksiNilai, NotificationDropdown, NotificationsList, Notifikasi
...
### Community 53 - "Semester"
Cohesion: 0.07
Nodes (8): RaporPdfController, EkstrakurikulerSaya, Ekstrakurikuler, Rapor, RaporDetail, Semester, SiswaEkstrakurikuler, SiswaKelas
...
### Community 58 - "ManajemenKurikulumMerdeka"
Cohesion: 0.18
...
Cohesion: 0.10
Nodes (5): ArusMasuk, RiwayatAktivitas, TabunganSaya, Livewire\Component, Livewire\WithPagination
...
### Community 235 - "User"
Cohesion: 0.08
Nodes (11): ManajemenUser, ManajemenKaryawan, Role, User, Illuminate\Foundation\Auth\User, Illuminate\Notifications\Notifiable, GuruRoleAccessTest, GuruStudentClassDisplayTest (+3 more)
...
### Community 285 - "post-autoload-dump"
Cohesion: 0.67
...
- **Why does `Siswa` connect `Siswa` to `ProductionDataSeeder.php`, `Illuminate\Http\Request`, `Tagihan`, `DetailTagihanSiswa`, `KelolaRapor`, `RekapAbsensiSiswa`, `Kelas`, `ManajemenSurat`, `Siswa.php`, `Auditable.php`, `NilaiTahfidz`, `GuruMapelKelas`, `AutomatedSppGenerationTest`, `TabunganSiswa`, `InputNilaiSumatif.php`, `TahunAjaran`, `PenilaianP5.php`, `ManajemenRemedial`, `ManajemenTagihan`, `Semester`, `ProsesKenaikanKelas`, `ManajemenKurikulumMerdeka`, `InputNilaiSiswa`, `OverviewPembayaran`, `InputPembayaran`, `AbsensiSiswa`, `Nilai`, `User`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `Guru` connect `Guru` to `ProductionDataSeeder.php`, `User.php`, `Tagihan`, `AbsensiGuru`, `Kelas`, `DetailGajiGuru`, `ManajemenSurat`, `ManajemenGajiGuru`, `Auditable.php`, `NilaiTahfidz`, `GuruMapelKelas`, `CapaianGuru`, `ManajemenRemedial`, `Semester`, `Nilai`, `JadwalPiketGuru`, `Livewire\Component`, `ManajemenPeminjaman`, `User`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `GuruMapelKelas` connect `GuruMapelKelas` to `JadwalPelajaran`, `InputNilaiSiswa`, `ManajemenJadwal`, `ManajemenRemedial`, `AbsensiSiswa`, `RekapAbsensiSiswa`, `Siswa.php`, `Semester`, `Auditable.php`, `PengaturanBobotNilai`?**
