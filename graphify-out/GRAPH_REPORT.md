...
## Corpus Check
- 495 files · ~389,561 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2720 nodes · 5799 edges · 344 communities (246 shown, 98 thin omitted)
...
6. `Semester` - 72 edges
7. `Tagihan` - 72 edges
8. `TahunAjaran` - 71 edges
9. `Pembayaran` - 66 edges
10. `TestCase` - 57 edges
...
## Communities (344 total, 98 thin omitted)
...
### Community 4 - "User"
Cohesion: 0.10
Nodes (6): User, Illuminate\Foundation\Auth\User, Illuminate\Notifications\Notifiable, GuruRoleAccessTest, SuperAdmin2ProductionSeederAndMurottalTest, TataUsahaShadowTeacherTest
...
### Community 17 - "Kelas"
Cohesion: 0.10
Nodes (3): PlottingSiswaKelas, Kelas, KenaikanKelasExportTest
...
Cohesion: 0.09
Nodes (10): AbsensiSiswa, Ekstrakurikuler, JadwalPelajaran, JadwalRemedial, ProyekP5, RaporTahfidzDetail, SubdimensiP5, TargetHafalanTahfidz (+2 more)
...
Cohesion: 0.11
Nodes (5): InputNilaiSumatif, RaporNilai, NilaiSas, NilaiSumatifTp, AutoNarasiService
...
### Community 39 - "Role"
Cohesion: 0.10
Nodes (8): Role, SuperAdmin2ProductionSeeder, Illuminate\Foundation\Testing\RefreshDatabase, Illuminate\Foundation\Testing\TestCase, GuruDashboardTest, GuruStudentClassDisplayTest, TahfidzParentFeedbackTest, TestCase
...
Cohesion: 0.09
Nodes (14): CapaianGuruSeeder, DatabaseSeeder, DemoDataSeeder, FinanceSeeder, JenisTagihanSeeder, KategoriPengeluaranSeeder, KomponenNilaiSeeder, ProductionAccountsSeeder (+6 more)
...
Cohesion: 0.07
Nodes (9): GenerateMonthlySpp, GenerateMonthlySppCommand, OverviewPembayaran, JenisTagihan, TahunAjaran, Command, Illuminate\Console\Command, BusinessLogicSecurityAndIntegrityTest (+1 more)
...
Cohesion: 0.16
Nodes (3): Pembayaran, Illuminate\Database\Eloquent\SoftDeletes, createUserWithRole()
...
Cohesion: 0.10
Nodes (6): ManajemenKurikulumMerdeka, ManajemenMapel, MataPelajaran, TemplateDeskripsi, TujuanPembelajaran, SuperAdmin2MonitoringGuruTest
...
### Community 268 - "Siswa"
Cohesion: 0.08
Nodes (3): TabunganSaya, Siswa, Student
...
### Community 280 - "Semester"
Cohesion: 0.09
Nodes (6): RaporPdfController, Rapor, RaporDetail, Semester, SiswaKelas, PenilaianTpDanSasTest

### Community 281 - "GuruMapelKelas"
Cohesion: 0.12
...
Cohesion: 0.14
Nodes (3): Tagihan, AutomatedSppGenerationTest, TagihanZeroNominalAndPaymentDeletionTest
...
## Knowledge Gaps
- **599 isolated node(s):** `$schema`, `name`, `type`, `description`, `laravel` (+594 more)
...
- **Why does `Siswa` connect `Siswa` to `AbsensiSiswa`, `CatatanPendampinganIndex`, `AuditLogger`, `KategoriPengeluaran`, `User`, `DetailTagihanSiswa`, `Livewire\Component`, `KalenderAkademik`, `ManajemenSurat`, `Kelas`, `ManajemenSiswa`, `Ekstrakurikuler`, `Semester`, `Illuminate\Database\Eloquent\Model`, `GuruMapelKelas`, `ProsesKenaikanKelas`, `NilaiSas`, `TabunganSiswa`, `PengajuanDanaIndex`, `NilaiP5`, `Role`, `Tagihan`, `Closure`, `Pengaturan.php`, `ManajemenTagihan`, `Kelas.php`, `Illuminate\Database\Seeder`, `ManajemenRemedial`, `KelolaRapor`, `.getMatrixData`, `TahunAjaran`, `RekapAbsensiSiswa`, `FinancialApprovalService`, `NilaiTahfidz`, `User.php`, `.run`, `.mount`, `ArusKasFilterInvestigationTest`, `AcademicAndFinanceEnhancementsTest`, `.mount`, `Dashboard`, `SetoranTahfidz`, `MataPelajaran`, `EkstrakurikulerModuleTest`, `InputPembayaran`, `GuruMapelKelas.php`?**
  _High betweenness centrality (0.072) - this node is a cross-community bridge._
- **Why does `Guru` connect `Guru` to `CatatanPendampinganIndex`, `KategoriPengeluaran`, `User`, `AbsensiGuru`, `KalenderAkademik`, `DetailGajiGuru`, `ManajemenSurat`, `ManajemenGajiGuru`, `ManajemenSiswa`, `Ekstrakurikuler`, `Semester`, `GuruMapelKelas`, `Illuminate\Database\Eloquent\Model`, `PengajuanDanaIndex`, `CapaianGuru`, `Role`, `Closure`, `ManajemenKelas`, `ManajemenGuru`, `Kelas.php`, `Illuminate\Database\Seeder`, `ManajemenRemedial`, `ManajemenKaryawan`, `TahunAjaran`, `KasbonGuruFilterWaktuTest`, `NilaiTahfidz`, `User.php`, `.run`, `.mount`, `ArusKasFilterInvestigationTest`, `AcademicAndFinanceEnhancementsTest`, `.mount`, `Dashboard`, `RekapAbsensiGuru`, `MataPelajaran`, `JadwalPiketGuru`, `EkstrakurikulerModuleTest`, `RoleFilterAuditAndGuruTest`, `ManajemenPeminjaman`, `GuruMapelKelas.php`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `ManajemenTagihan` connect `ManajemenTagihan` to `TahunAjaran`, `KategoriPengeluaran`, `Livewire\Component`, `User.php`, `Siswa`, `WithDateFilter.php`?**
