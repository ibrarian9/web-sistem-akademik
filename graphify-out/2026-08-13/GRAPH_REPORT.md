...
## Corpus Check
- 348 files · ~215,385 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1675 nodes · 3176 edges · 234 communities (172 shown, 62 thin omitted)
...
## Communities (234 total, 62 thin omitted)
...
Cohesion: 0.11
Nodes (9): AbsensiSiswa, DanaBos, JadwalPelajaran, JadwalRemedial, Peminjaman, SubdimensiP5, TargetHafalanTahfidz, Illuminate\Database\Eloquent\Factories\HasFactory (+1 more)
...
### Community 36 - ".run"
Cohesion: 0.18
Nodes (4): EkstrakurikulerSaya, Ekstrakurikuler, SiswaEkstrakurikuler, RaporOrangTuaSeeder
...
### Community 40 - "Rapor"
Cohesion: 0.16
Nodes (4): RaporPdfController, Rapor, RaporDetail, RaporTahfidzDetail
...
### Community 200 - ".run"
Cohesion: 0.15
Nodes (3): BobotNilaiGuru, Nilai, ProductionDataSeeder
...
- **Why does `User` connect `User` to `Illuminate\Database\Eloquent\Model`, `Pembayaran.php`, `ManajemenSiswa`, `InputAbsensiKaryawan`, `Tagihan`, `Role`, `Livewire\Component`, `TahunAjaran`, `.run`, `Siswa.php`, `Pengeluaran`, `UserFactory.php`, `.run`, `Semester`, `.paySalary`, `ProductionDataSeeder.php`, `Pengaturan`, `TestCase`, `Tagihan.php`, `ManajemenGuru`, `.run`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `Kelas` connect `Kelas` to `MataPelajaran`, `Illuminate\Database\Eloquent\Model`, `Pembayaran.php`, `ManajemenSiswa`, `Role`, `NilaiTahfidz`, `JenisTagihan`, `PenilaianP5.php`, `TabunganSiswa`, `TahunAjaran`, `Pembayaran`, `ProsesKenaikanKelas`, `InputPembayaran`, `.run`, `Siswa.php`, `ManajemenRemedial`, `RekapAbsensiSiswa`, `.run`, `Semester`, `Guru`, `ManajemenKelas`, `KelolaRapor`, `.getMatrixData`, `.run`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `Siswa` connect `Siswa` to `MataPelajaran`, `Illuminate\Database\Eloquent\Model`, `Pembayaran.php`, `ManajemenSiswa`, `Kelas`, `Tagihan`, `ManajemenSurat`, `Role`, `NilaiTahfidz`, `JenisTagihan`, `AbsensiSiswa`, `PenilaianP5.php`, `TabunganSiswa`, `TahunAjaran`, `Pembayaran`, `ProsesKenaikanKelas`, `InputPembayaran`, `.run`, `OverviewPembayaran`, `Rapor`, `Siswa.php`, `ManajemenRemedial`, `KomponenNilai`, `RekapAbsensiSiswa`, `Pengeluaran`, `.run`, `Semester`, `Guru`, `KelolaRapor`, `.getMatrixData`, `.run`?**
