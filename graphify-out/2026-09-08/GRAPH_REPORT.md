...
## Corpus Check
- 449 files · ~343,720 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2340 nodes · 4710 edges · 312 communities (234 shown, 78 thin omitted)
- Extraction: 85% EXTRACTED · 15% INFERRED · 0% AMBIGUOUS · INFERRED: 694 edges (avg confidence: 0.8)
...
## Communities (312 total, 78 thin omitted)

### Community 0 - "Notifikasi"
Cohesion: 0.10
Nodes (5): OverviewPembayaran, NotificationsList, Notifikasi, AuditLogger, bootAuditable()
...
Cohesion: 0.11
Nodes (5): GenerateMonthlySpp, GenerateMonthlySppCommand, Tagihan, Illuminate\Console\Command, AutomatedSppGenerationTest
...
### Community 235 - "User"
Cohesion: 0.07
Nodes (10): ManajemenKaryawan, Role, User, Illuminate\Foundation\Auth\User, Illuminate\Notifications\Notifiable, KalenderAkademikTanggalMerahTest, KalenderAkademikTest, KenaikanKelasExportTest (+2 more)
...
### Community 280 - "Rapor"
Cohesion: 0.14
Nodes (3): KelolaRapor, Rapor, RaporDetail
...
Cohesion: 0.13
Nodes (7): Illuminate\Foundation\Testing\RefreshDatabase, Illuminate\Foundation\Testing\TestCase, GuruDashboardTest, GuruRoleAccessTest, GuruStudentClassDisplayTest, TahfidzParentFeedbackTest, TestCase
...
Cohesion: 0.08
Nodes (6): JenisTagihan, Semester, SiswaKelas, TahunAjaran, Command, SuperAdmin2AndFinancialApprovalTest
...
- **Why does `Siswa` connect `Siswa` to `Notifikasi`, `Illuminate\Http\Request`, `Pembayaran`, `DetailTagihanSiswa`, `NilaiSas`, `ApprovalKeuangan`, `ManajemenSurat`, `Siswa.php`, `Rapor`, `Auditable.php`, `ManajemenRemedial`, `.getMatrixData`, `TabunganSiswa`, `NilaiP5`, `InputNilaiSumatif`, `ManajemenTagihan`, `Livewire\WithPagination`, `User.php`, `RekapAbsensiSiswa`, `TahunAjaran`, `Kelas`, `ProsesKenaikanKelas`, `KomponenNilai`, `NilaiTahfidz`, `InputPembayaran`, `AbsensiSiswa`, `Guru`, `Tagihan`, `User`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `Guru` connect `Guru` to `CapaianGuru`, `Guru.php`, `NilaiTahfidz`, `InputAbsensiKaryawan`, `Siswa`, `User`, `DetailGajiGuru`, `ManajemenSurat`, `ManajemenGajiGuru`, `GajiGuru`, `Livewire\WithPagination`, `Kelas`, `TahunAjaran`, `JadwalPiketGuru`, `Auditable.php`, `ManajemenRemedial`, `ManajemenPeminjaman`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `TahunAjaran` connect `TahunAjaran` to `Notifikasi`, `Illuminate\Http\Request`, `Pembayaran`, `DetailTagihanSiswa`, `ManajemenKalenderAkademik`, `Siswa`, `GajiGuru`, `Auditable.php`, `KepalaSekolahDanaBosMonitoringTest`, `LaporanTunggakan`, `ManajemenTagihan`, `Livewire\WithPagination`, `User.php`, `Kelas`, `NilaiTahfidz`, `ArusKasMasuk`, `Guru`, `Tagihan`, `User`?**
