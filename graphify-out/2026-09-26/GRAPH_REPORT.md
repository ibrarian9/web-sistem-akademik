# Graph Report - web-sistem-akademik  (2026-09-26)

## Corpus Check
- 651 files · ~466,690 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3468 nodes · 7159 edges · 466 communities (323 shown, 143 thin omitted)
...
## Communities (466 total, 143 thin omitted)

### Community 1 - "Livewire\Form"
Cohesion: 0.11
Nodes (5): GajiGuruForm, KasMasukForm, KategoriTagihanForm, GuruForm, Livewire\Form
...
### Community 3 - "Siswa"
Cohesion: 0.05
Nodes (8): GenerateMonthlySpp, GenerateMonthlySppCommand, TabunganSaya, Dashboard, DataAlumni, Siswa, Student, Illuminate\Console\Command
...
Cohesion: 0.05
Nodes (6): ApprovalKeuanganIndex, ApprovalKeuangan, FinancialApprovalService, ApprovalKeuanganBulkActionsTest, FinancialApprovalCancellationTest, SuperAdmin2AndFinancialApprovalTest
...
Cohesion: 0.09
Nodes (5): ArusMasuk, Dashboard, EkstrakurikulerSaya, Livewire\Component, Livewire\WithPagination

### Community 17 - "Kelas"
Cohesion: 0.07
Nodes (4): Dashboard, PlottingSiswaKelas, Kelas, OverviewPembayaranMatrixExportTest
...
Cohesion: 0.08
Nodes (12): AbsensiSiswa, BobotNilaiGuru, Ekstrakurikuler, JadwalPelajaran, JadwalRemedial, ProyekP5, RaporTahfidzDetail, SiswaKelas (+4 more)

### Community 26 - "User.php"
Cohesion: 0.19
Nodes (3): Pembayaran, Tabungan, Illuminate\Database\Eloquent\SoftDeletes
...
Cohesion: 0.13
Nodes (4): PenilaianP5, RaporNilai, DimensiP5, NilaiP5
...
### Community 206 - "ManajemenSurat"
Cohesion: 0.11
Nodes (4): ManajemenSurat, RiwayatSurat, ESignatureService, ESignatureTest
...
### Community 235 - "Guru"
Cohesion: 0.04
Nodes (5): ManajemenKelas, Guru, KasbonGuruFilterWaktuTest, RoleFilterAuditAndGuruTest, SuperAdmin2MonitoringGuruTest
...
### Community 264 - "unmask_rupiah"
Cohesion: 0.33
Nodes (4): format_rupiah(), unmask_rupiah(), sanitizeCurrencies(), sanitizeCurrency()

### Community 267 - "Login.php"
Cohesion: 0.10
Nodes (9): RoleMiddleware, Login, AppServiceProvider, EligibleShadowTeacher, MaxOneShadowTeacherPerClass, Closure, Illuminate\Contracts\Validation\ValidationRule, Illuminate\Support\ServiceProvider (+1 more)
...
Cohesion: 0.08
Nodes (6): Ekstrakurikuler, ManajemenEkstrakurikuler, KegiatanEkstrakurikuler, PresensiEkstrakurikuler, SiswaEkstrakurikuler, EkstrakurikulerModuleTest

### Community 280 - "Rapor"
Cohesion: 0.12
Nodes (4): RaporPdfController, Rapor, RaporDetail, MonitoringAkademikTest
...
Cohesion: 0.04
Nodes (7): DeleteTagihanAction, Tagihan, AutomatedSppGenerationTest, ManajemenTagihanMatrixTest, OverviewPembayaranDetailedMatrixTest, TagihanTunggakanJatuhTempoVsMendatangTest, TagihanZeroNominalAndPaymentDeletionTest
...
### Community 304 - "TahunAjaran"
Cohesion: 0.06
Nodes (6): Semester, TahunAjaran, BusinessLogicSecurityAndIntegrityTest, PenilaianTpDanSasTest, TagihanDetail6MonthMatrixTest, TagihanOneTimePaymentMatrixTest
...
### Community 328 - "User"
Cohesion: 0.06
Nodes (12): KaryawanForm, Role, User, Illuminate\Foundation\Auth\User, Illuminate\Notifications\Notifiable, ArusKasCustomKategoriDanFilterCardTest, DeletionCascadeAndNoFutureArrearsTest, FinanceBulkGajiPerformanceTest (+4 more)
...
Cohesion: 0.08
Nodes (5): ManageKategoriTagihanAction, JenisTagihan, Command, KategoriTagihanCustomManagementTest, TagihanBulkPerformanceTest
...
Cohesion: 0.11
Nodes (6): ManajemenKurikulumMerdeka, ManajemenMapel, LingkupMateri, MataPelajaran, TujuanPembelajaran, Illuminate\Database\Eloquent\Relations\HasMany

### Community 461 - "Pengaturan.php"
Cohesion: 0.17
...
Cohesion: 0.12
Nodes (6): InputNilaiSumatif, NilaiSas, NilaiSumatifTp, TemplateDeskripsi, AutoNarasiService, Illuminate\Database\Eloquent\Relations\BelongsTo
...
- **Why does `Siswa` connect `Siswa` to `CatatanPendampinganIndex`, `AuditLogger`, `KomponenNilai`, `DetailTagihanSiswa`, `KategoriPengeluaran`, `Login.php`, `ApprovalKeuangan`, `Livewire\Component`, `Notifikasi`, `Kelas`, `ManajemenSiswa`, `Ekstrakurikuler`, `Rapor`, `Illuminate\Database\Eloquent\Model`, `User.php`, `AbsensiSiswa`, `TabunganSiswa`, `NilaiP5`, `Tagihan`, `ManajemenGuru`, `Kelas.php`, `ManajemenTagihan`, `TahunAjaran`, `SetoranTahfidz`, `ProsesKenaikanKelas`, `ManajemenRemedial`, `FinanceReportService`, `JenisTagihan`, `Nilai`, `RekapAbsensiSiswa`, `MataPelajaran`, `NilaiTahfidz`, `User`, `KelolaRapor`, `Pengaturan.php`, `ManajemenSurat`, `SiswaForm`, `AbsensiGuru`, `Role.php`, `OverviewPembayaran`, `InputPembayaran`, `NilaiSas`, `Guru`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `Tagihan` connect `Tagihan` to `DetailTagihanSiswa`, `ApprovalKeuangan`, `Notifikasi`, `Kelas`, `Rapor`, `Illuminate\Database\Eloquent\Model`, `User.php`, `LaporanTunggakan`, `NilaiP5`, `ManajemenTagihan`, `TahunAjaran`, `JadwalPelajaran`, `FinanceReportService`, `JenisTagihan`, `TagihanSpp`, `User`, `Role.php`, `InputPembayaran`, `Dashboard`, `ReleaseBillsAction`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `User` connect `User` to `AuditLogger`, `KomponenNilai`, `KategoriPengeluaran`, `ApprovalKeuangan`, `AcademicAndFinanceEnhancementsTest`, `Notifikasi`, `Kelas`, `Ekstrakurikuler`, `ManajemenKaryawan`, `Rapor`, `Illuminate\Database\Eloquent\Model`, `User.php`, `ArusKasFilterInvestigationTest`, `KepalaSekolahDanaBosMonitoringTest`, `Tagihan`, `Kelas.php`, `TahunAjaran`, `ManajemenUser`, `JenisTagihan`, `InputAbsensiKaryawan`, `MataPelajaran`, `GajiGuru`, `Pengaturan.php`, `ManajemenSurat`, `Role.php`, `Guru`, `DanaBos`?**
