# Graph Report - web-sistem-akademik  (2026-09-25)

## Corpus Check
- 648 files · ~463,658 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3448 nodes · 7028 edges · 476 communities (329 shown, 147 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 961 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8ea09290`
...
4. `Kelas` - 121 edges
5. `Guru` - 114 edges
6. `TahunAjaran` - 106 edges
7. `Semester` - 87 edges
8. `Role` - 83 edges
9. `TestCase` - 76 edges
10. `Pembayaran` - 75 edges
...
## Communities (476 total, 147 thin omitted)

### Community 1 - "Livewire\Form"
Cohesion: 0.21
Nodes (3): GajiGuruForm, KasKeluarForm, Livewire\Form
...
### Community 3 - "Siswa"
Cohesion: 0.05
Nodes (5): TabunganSaya, Siswa, Student, Tabungan, Command
...
### Community 9 - "Role.php"
Cohesion: 0.12
Nodes (7): Illuminate\Foundation\Testing\RefreshDatabase, Illuminate\Foundation\Testing\TestCase, GuruDashboardTest, OverviewPembayaranMatrixExportTest, TahfidzParentFeedbackTest, TataUsahaShadowTeacherTest, TestCase
...
### Community 15 - "FinancialApprovalService"
Cohesion: 0.16
...
Cohesion: 0.14
Nodes (3): NotificationsList, Notifikasi, NotificationService
...
Cohesion: 0.11
Nodes (10): AbsensiSiswa, BobotNilaiGuru, Ekstrakurikuler, JadwalPelajaran, RaporTahfidzDetail, SubdimensiP5, TargetHafalanTahfidz, TemplateDeskripsi (+2 more)

### Community 26 - "KategoriPengeluaran"
Cohesion: 0.18
Nodes (3): KategoriPengeluaran, Illuminate\Database\Eloquent\SoftDeletes, Livewire\WithFileUploads
...
Cohesion: 0.05
Nodes (8): AbsensiSiswa, JadwalMengajar, Dashboard, JadwalPelajaran, KehadiranSaya, RekapAbsensiSiswa, ManajemenJadwal, JadwalService
...
### Community 235 - "Guru"
Cohesion: 0.06
Nodes (5): GuruForm, Dashboard, Guru, GuruStudentClassDisplayTest, RoleFilterAuditAndGuruTest
...
Cohesion: 0.08
Nodes (4): TahunAjaran, KalenderAkademikTest, ManajemenTagihanMatrixTest, SuperAdmin2AndFinancialApprovalTest

### Community 268 - "User"
Cohesion: 0.06
Nodes (15): KaryawanForm, Role, User, ProductionAccountsSeeder, SuperAdmin2ProductionSeeder, UserSeeder, Illuminate\Foundation\Auth\User, Illuminate\Notifications\Notifiable (+7 more)
...
### Community 280 - "Rapor"
Cohesion: 0.15
Nodes (4): Rapor, RaporDetail, RaporOrangTuaSeeder, PenilaianTpDanSasTest
...
### Community 285 - "FinanceExportController"
Cohesion: 0.29
...
Cohesion: 0.05
Nodes (7): DeleteTagihanAction, Tagihan, AutomatedSppGenerationTest, OverviewPembayaranDetailedMatrixTest, TagihanOneTimePaymentMatrixTest, TagihanTunggakanJatuhTempoVsMendatangTest, TagihanZeroNominalAndPaymentDeletionTest
...
### Community 304 - "Semester"
Cohesion: 0.08
Nodes (7): Dashboard, Semester, CapaianGuruSeeder, DemoDataSeeder, BusinessLogicSecurityAndIntegrityTest, EkstrakurikulerModuleTest, TagihanDetail6MonthMatrixTest

### Community 307 - "SalaryCalculationService"
Cohesion: 0.20
Nodes (3): GenerateBulkGajiAction, SalaryBulkGeneratorService, SalaryCalculationService

### Community 308 - ".previewPdf"
Cohesion: 0.28
Nodes (4): Controller, DocumentVerificationController, PendampinganReportController, RaporPdfController
...
### Community 439 - ".run"
Cohesion: 0.14
Nodes (3): Nilai, SiswaKelas, ProductionDataSeeder
...
Cohesion: 0.12
Nodes (3): ManageKategoriTagihanAction, JenisTagihan, KategoriTagihanCustomManagementTest
...
### Community 460 - "GajiGuru"
Cohesion: 0.09
Nodes (7): DisburseGajiAction, GajiGuru, Peminjaman, CashFlowService, FinanceSeeder, Illuminate\Support\Collection, FinanceEditGajiTest

### Community 461 - "MataPelajaran"
Cohesion: 0.15
...
## Knowledge Gaps
- **855 isolated node(s):** `$schema`, `name`, `type`, `description`, `laravel` (+850 more)
...
- **Why does `Siswa` connect `Siswa` to `CatatanPendampinganIndex`, `AuditLogger`, `.resolveForeignKeyValue`, `DetailTagihanSiswa`, `TahunAjaran`, `Role.php`, `User`, `AcademicAndFinanceEnhancementsTest`, `FinancialApprovalService`, `Notifikasi`, `Kelas`, `ManajemenSiswa`, `Rapor`, `Illuminate\Database\Eloquent\Model`, `KategoriPengeluaran`, `Semester.php`, `TabunganSiswa`, `AbsensiSiswa`, `.getMatrixData`, `NilaiP5`, `Tagihan`, `EligibleShadowTeacher.php`, `ManajemenGuru`, `Livewire\Component`, `ManajemenTagihan`, `Semester`, `ManajemenEkstrakurikuler`, `.previewPdf`, `ManajemenRemedial`, `KelolaRapor`, `.run`, `InputNilaiSumatif`, `FinanceReportService`, `JenisTagihan`, `Pengaturan.php`, `Illuminate\Database\Seeder`, `NilaiTahfidz`, `ArusKasFilterInvestigationTest`, `GajiGuru`, `MataPelajaran`, `ManajemenSurat`, `SiswaForm`, `LingkupMateri`, `User.php`, `OverviewPembayaran`, `InputPembayaran`, `ProsesKenaikanKelas`, `NilaiSas`, `Guru`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `Tagihan` connect `Tagihan` to `Siswa`, `.resolveForeignKeyValue`, `DetailTagihanSiswa`, `TahunAjaran`, `Role.php`, `User`, `FinancialApprovalService`, `Notifikasi`, `Kelas`, `Rapor`, `Illuminate\Database\Eloquent\Model`, `KategoriPengeluaran`, `LaporanTunggakan`, `AbsensiSiswa`, `ManajemenTagihan`, `Semester`, `.previewPdf`, `.run`, `FinanceReportService`, `JenisTagihan`, `TagihanSpp`, `ArusKasFilterInvestigationTest`, `GajiGuru`, `SiswaForm`, `Dashboard`, `User.php`, `OverviewPembayaran`, `InputPembayaran`, `NilaiSas`, `ReleaseBillsAction`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `User` connect `User` to `AuditLogger`, `.resolveForeignKeyValue`, `TahunAjaran`, `Role.php`, `AcademicAndFinanceEnhancementsTest`, `FinancialApprovalService`, `Notifikasi`, `ManajemenKaryawan`, `Rapor`, `Illuminate\Database\Eloquent\Model`, `KategoriPengeluaran`, `Semester.php`, `KepalaSekolahDanaBosMonitoringTest`, `Tagihan`, `Livewire\Component`, `Semester`, `ManajemenUser`, `.run`, `JenisTagihan`, `AbsensiGuru`, `Pengaturan.php`, `ArusKasCustomKategoriDanFilterCardTest`, `NilaiTahfidz`, `ArusKasFilterInvestigationTest`, `GajiGuru`, `MataPelajaran`, `SiswaForm`, `KasbonGuruFilterWaktuTest`, `User.php`, `ESignatureService`, `Guru`, `DanaBos`?**
...
- **Are the 78 inferred relationships involving `Tagihan` (e.g. with `.cleanupDuplicateUnpaidBills()` and `.delete()`) actually correct?**
  _`Tagihan` has 78 INFERRED edges - model-reasoned connections that need verification._
