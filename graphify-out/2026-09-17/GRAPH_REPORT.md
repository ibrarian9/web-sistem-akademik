# Graph Report - web-sistem-akademik  (2026-09-17)

## Corpus Check
- 630 files · ~422,278 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3267 nodes · 6620 edges · 461 communities (325 shown, 136 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 919 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f789e4d2`
...
## Communities (461 total, 136 thin omitted)

### Community 1 - "ManajemenJadwal"
Cohesion: 0.07
Nodes (5): JadwalMengajar, JadwalPelajaran, ManajemenGuru, ManajemenJadwal, JadwalService
...
Cohesion: 0.08
Nodes (4): ArusKasKeluar, Peminjaman, Pengeluaran, CashFlowService
...
### Community 55 - "Role"
Cohesion: 0.08
Nodes (9): ManajemenKaryawan, Role, ProductionAccountsSeeder, SuperAdmin2ProductionSeeder, UserSeeder, GuruRoleAccessTest, KenaikanKelasExportTest, createUserWithRole() (+1 more)
...
Cohesion: 0.12
Nodes (10): DatabaseSeeder, FinanceSeeder, JenisTagihanSeeder, KategoriPengeluaranSeeder, KomponenNilaiSeeder, PengaturanSeeder, ProductionDataSeeder, RoleSeeder (+2 more)
...
### Community 74 - "User"
Cohesion: 0.07
Nodes (8): KaryawanForm, User, Illuminate\Foundation\Auth\User, Illuminate\Notifications\Notifiable, AutomatedSppGenerationTest, EkstrakurikulerModuleTest, GuruStudentClassDisplayTest, TataUsahaShadowTeacherTest
...
### Community 204 - "FinanceExportController"
Cohesion: 0.27
...
Cohesion: 0.13
Nodes (5): ManajemenKurikulumMerdeka, LingkupMateri, TujuanPembelajaran, Illuminate\Database\Eloquent\Relations\HasMany, MonitoringAkademikTest
...
Cohesion: 0.15
Nodes (4): GajiGuruForm, KasKeluarForm, KategoriTagihanForm, Livewire\Form
...
Cohesion: 0.08
Nodes (5): Login, ArusMasuk, EkstrakurikulerSaya, Livewire\Component, Livewire\WithPagination

### Community 268 - ".handle"
Cohesion: 0.40
...
Cohesion: 0.06
Nodes (4): DeleteTagihanAction, Tagihan, SuperAdmin2AndFinancialApprovalTest, TagihanTunggakanJatuhTempoVsMendatangTest
...
Cohesion: 0.09
Nodes (6): TahunAjaran, CapaianGuruSeeder, BusinessLogicSecurityAndIntegrityTest, DeletionCascadeAndNoFutureArrearsTest, KalenderAkademikTanggalMerahTest, KalenderAkademikTest
...
Cohesion: 0.40
Nodes (4): deleteTagihan({{ $item->id }}), openEditModal({{ $item->id }}), resetFilters, setCategoryTab(
...
### Community 351 - "DanaBos"
Cohesion: 0.09
Nodes (5): DanaBosForm, DanaBos, DanaBos, DanaBosBuktiTransaksiTest, KepalaSekolahDanaBosMonitoringTest
...
## Knowledge Gaps
- **786 isolated node(s):** `$schema`, `name`, `type`, `description`, `laravel` (+781 more)
...
- **Why does `Siswa` connect `Siswa` to `CatatanPendampinganIndex`, `ManajemenJadwal`, `ManajemenSurat`, `DetailTagihanSiswa`, `Livewire\Component`, `.handle`, `AcademicAndFinanceEnhancementsTest`, `Kelas`, `ManajemenSiswa`, `Ekstrakurikuler`, `Rapor`, `Illuminate\Database\Eloquent\Model`, `Kelas.php`, `RekapAbsensiSiswa`, `FinancialApprovalService`, `NilaiSas`, `TabunganSiswa`, `Pengeluaran`, `JenisTagihan`, `NilaiP5`, `Role.php`, `Tabungan`, `Tagihan`, `Closure`, `InputNilaiSiswa`, `Pengaturan.php`, `ManajemenTagihan`, `Nilai`, `ProsesKenaikanKelas`, `ManajemenRemedial`, `.resolveForeignKeyValue`, `Role`, `FinanceReportService`, `Controller`, `TahunAjaran`, `MataPelajaran.php`, `AbsensiSiswa`, `ArusKasFilterInvestigationTest`, `.getMatrixData`, `Semester`, `User`, `GuruMapelKelas`, `SiswaForm`, `LingkupMateri`, `OverviewPembayaran`, `MataPelajaran`, `InputPembayaran`?**
  _High betweenness centrality (0.079) - this node is a cross-community bridge._
- **Why does `User` connect `User` to `ManajemenJadwal`, `AuditLogger`, `AcademicAndFinanceEnhancementsTest`, `Notifikasi`, `ManajemenUser`, `Rapor`, `Illuminate\Database\Eloquent\Model`, `Kelas.php`, `FinancialApprovalService`, `Pengeluaran`, `JenisTagihan`, `Role.php`, `Tagihan`, `Pengaturan.php`, `KasbonGuruFilterWaktuTest`, `ProsesKenaikanKelas`, `Role`, `.resolveForeignKeyValue`, `TahunAjaran`, `MataPelajaran.php`, `DisburseGajiAction.php`, `ArusKasFilterInvestigationTest`, `Semester`, `ArusKasCustomKategoriDanFilterCardTest`, `SiswaForm`, `LingkupMateri`, `ESignatureService`, `MataPelajaran`, `AbsensiGuru`, `DanaBos`, `Guru`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `Guru` connect `Guru` to `CatatanPendampinganIndex`, `ManajemenJadwal`, `ManajemenSurat`, `ManajemenKelas`, `ManajemenPeminjaman`, `AcademicAndFinanceEnhancementsTest`, `DetailGajiGuru`, `Kelas`, `GajiGuru`, `ManajemenSiswa`, `Ekstrakurikuler`, `Rapor`, `Illuminate\Database\Eloquent\Model`, `Kelas.php`, `Pengeluaran`, `CapaianGuru`, `Role.php`, `Closure`, `Nilai`, `KasbonGuruFilterWaktuTest`, `SalaryCalculationService`, `ProsesKenaikanKelas`, `ManajemenRemedial`, `.resolveForeignKeyValue`, `Role`, `TahunAjaran`, `MataPelajaran.php`, `ArusKasFilterInvestigationTest`, `RekapAbsensiGuru`, `Semester`, `JadwalPiketGuru`, `User`, `GuruMapelKelas`, `LingkupMateri`, `MataPelajaran`, `AbsensiGuru`?**
